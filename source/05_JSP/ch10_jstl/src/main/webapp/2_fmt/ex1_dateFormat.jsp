...
<body>
	...
	<h3>시간만 출력</h3>
	short:<fmt:formatDate value="${nowUtilDate }" type="date" dateStyle="short"/><br>
	medium:<fmt:formatDate value="${nowUtilDate }" type="date" dateStyle="medium"/><br>
	long:<fmt:formatDate value="${nowUtilDate }" type="date" dateStyle="long"/><br>
